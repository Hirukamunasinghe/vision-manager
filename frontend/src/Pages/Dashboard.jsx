  ...
  return (
    <div className="flex">
      ...
      >
        ...
        <div className="p-4  ">
          <div className="bg-[#D0D2EC] p-4 space-y-6 rounded-md">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:flex justify-center gap-[200px] pt-[20px] xl:grid-cols-3 gap-3">
            <DashboardCard
              title="Total Videos"
              value="4,710"
              icon={<FaVideo />}
          ...
          <div className="border-t border-gray-300 pt-4 ">
            <div className="bg-[#AEB1C1]  p-6 rounded-lg h-[70px] mt-[20px] mb-[30px] shadow-md flex justify-end items-center space-x-8">
              {/* Search Bar */}
              <div className="flex w-[700px] mr-[60px] items-center border border-gray-300 bg-white rounded-lg p-2 space-x-2 focus-within:ring-2 focus-within:ring-blue-600 transition duration-200">
          ...
          <div>
            <h3 className="text-2xl font-medium text-black-400 mb-4 ">
              {" "}
              Running Videos
            </h3>
            <Video />
